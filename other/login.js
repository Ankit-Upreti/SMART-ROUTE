...
document.getElementById('login-form').addEventListener('submit', function(event) {
    ...
    // (Optional) Validate email format using a regular expression
    ...
    // Simulate successful login (you can also add more specific logic here)
    if (email && password) {
